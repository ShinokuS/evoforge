...
import io.github.evoforge.visualizer.screen.ContinuumInfiniteTimeInspectorScreen;
...
public final class Main extends Game {
    ...
    private void showContinuumInspectorNow() {
        replaceScreen(new ContinuumInfiniteTimeInspectorScreen(this::requestScenarioMenu));
    }
