...
public final class LivingCowScenario implements VisualizerScenario {
    ...
    public ScenarioSession create() {
        ...
        MaterialDefinitionId meadow = assembly.landscapeDefinition("scenario:living_meadow");
        MaterialDefinitionId basin = assembly.landscapeDefinition("scenario:living_puddle_basin");
        MaterialDefinitionId lakeFloor = assembly.landscapeDefinition("scenario:living_lake_floor");
