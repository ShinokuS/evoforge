...
public final class PathfindingHierarchyScenario implements VisualizerScenario {
    ...
    @Override public String description() { return "Long route crosses 8-cell hierarchy clusters; orange columns mark their cuts."; }
    ...
    public ScenarioSession create() {
        ...
        return new ScenarioSession(
                ...
                PathfindingScenarioDiagnostics.fromSearch(query, search, markers.toArray(ScenarioCellMarker[]::new)));
    }
}
