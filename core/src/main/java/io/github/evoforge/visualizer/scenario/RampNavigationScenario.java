...
public final class RampNavigationScenario implements VisualizerScenario {
    ...
    public ScenarioSession create() {
        ...
        ScenarioTerrain.placeRamp(
                assembly, ground, 0, -6, 0, RampShape.POSITIVE_Y);
        ScenarioTerrain.placeRamp(
                assembly, ground, 0, 6, 0, RampShape.NEGATIVE_Y);
        ScenarioTerrain.placeRamp(
                assembly, ground, -8, 0, 0, RampShape.POSITIVE_X);
        ScenarioTerrain.placeRamp(
                assembly, ground, 8, 0, 0, RampShape.NEGATIVE_X);
        ...
        ScenarioTerrain.placeRamp(
                assembly, ground, 2, 3, 2, RampShape.POSITIVE_X);

        ScenarioTerrain.fill(assembly, ground, 5, 6, 2, 4, 3);
        ScenarioTerrain.placeRamp(
                assembly, ground, 4, 3, 3, RampShape.POSITIVE_X);
