...
public final class CowVisualSearchScenario implements VisualizerScenario {
    ...
    @Override public String description() {
        return "Grass starts outside the cow's Vision. The hungry cow knows only that hunger has environmental solutions, performs a local visual sweep, then expands search through relative exploration until Grass actually enters perception.";
    }
    ...
    public ScenarioSession create() {
        ...
        return new ScenarioSession(
                runtime,
                new ScenarioView(0, 2.5f, 0f, 0.82f),
                controller);
    }
}
