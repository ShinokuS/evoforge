...
public record SimulationView(ObjectLookup objects, TransformLookup transforms, OrientationLookup orientations,
        VisionLookup vision, TerrainLookup terrain, TerrainExtentLookup terrainExtents,
        TerrainRevisionLookup terrainRevision, GeometryLookup geometry, NavigationLookup navigation,
        OccupancyLookup occupancy, CellObjectLookup cells, Pathfinder pathfinder, MoveToLookup moveTo,
        NeedLookup needs, AgentDecisionLookup agents) {
    public SimulationView {
        if (objects == null || transforms == null || orientations == null || vision == null || terrain == null
                || terrainExtents == null || terrainRevision == null || geometry == null || navigation == null
                || occupancy == null || cells == null || pathfinder == null || moveTo == null
                || needs == null || agents == null) {
