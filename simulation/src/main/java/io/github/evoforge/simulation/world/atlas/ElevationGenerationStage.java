 ...
 * V12 scale-stable landforms, V13 mountains, V14 bathymetry, and V15 continental basins.
 */
public final class ElevationGenerationStage implements ElevationGenerator {
    ...
    public ElevationField generate(WorldGenesis genesis) {
        ...
        if (GenerationRevision.V15.equals(revision)) return V15InlandBasinTerrainGenerator.standard().generate(genesis);
