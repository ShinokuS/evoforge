...
public final class GeneratedTerrainMaterialDiagnosticsProbe {
    ...
    public GeneratedTerrainMaterialDiagnostics snapshot(
        ...
        if (atlas == null || materials == null || palette == null) {
        ...
        for (long y = bounds.minY(); y <= (long) bounds.maxY(); y++) {
            ...
            for (long x = bounds.minX(); x <= (long) bounds.maxX(); x++) {
                ...
                TerrainMaterialKey surface = materials.materialAt(
                        worldX,
                        worldY,
                        surfaceZ);
                ...
                for (long z = bounds.minZ(); z <= (long) surfaceZ; z++) {
                    TerrainMaterialKey material = materials.materialAt(
                            worldX,
                            worldY,
                            (int) z);
    ...
    private static void add(
            ...
            TerrainMaterialKey material) {
        if (material == null) {
            throw new IllegalStateException(
                    "generated terrain material field returned null");
        }
