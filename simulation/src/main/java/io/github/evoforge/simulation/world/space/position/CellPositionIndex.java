...
import io.github.evoforge.simulation.world.space.position.ObjectPositionIndex;
...
public final class CellPositionIndex
    ...
    private final class LookupView
        ...
        public int objectCount(
            ...
            return CellPositionIndex.this.objectCount(
                    x,
                    y,
                    z);
        }
        ...
        public ObjectId objectAt(
            ...
            return CellPositionIndex.this.objectAt(
                    x,
                    y,
                    z,
                    index);
