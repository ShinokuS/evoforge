package io.github.evoforge.simulation.world.landscape.water.storage;

import java.util.HashMap;
import java.util.Map;

import io.github.evoforge.simulation.world.landscape.water.WaterStorage;
import io.github.evoforge.simulation.world.mechanics.geometry.CellVolume;

public final class SparseWaterStorage implements WaterStorage {
    ...
    public int amount(
        ...
        Integer amount = water.get(lookupProbe);
    ...
    public void put(
        ...
        if (amount == CellVolume.EMPTY) {
            throw new IllegalArgumentException(
                    "stored water amount must be positive");
        }
