...
final class AgentDefinitionCompilersTest {
    ...
    @Test
    void compilesAgentCapabilitiesAndPerceptionRadius() {
        ...
        compiler.compile(id, parse("""
                {
                  "perceptionRadius": 7,
                  "capabilities": ["core:graze", "core:drink"]
                }
                """), null);

        AgentDefinition definition = definitions.get(id);
        assertEquals(7, definition.perceptionRadius());
    ...
    void compilesNeedSatisfactionAsIndependentDefinitionAspect() {
        ...
        NeedSatisfactionDefinitionCompiler compiler =
                new NeedSatisfactionDefinitionCompiler(definitions);
